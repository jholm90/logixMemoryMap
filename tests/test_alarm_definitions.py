...
@pytest.mark.parametrize("name,members,definitions", [
    ("alarmdef_l902ts_d1_m01", 1, 1),
    ("alarmdef_l902ts_d1_m08", 8, 1),
    ("alarmdef_l902ts_d08_m1", 8, 8),
])
...
def test_a_definition_with_no_members_is_still_reported():
    ...
    gaps = _gaps("alarmdef_l902ts_d1_m00")
    assert len(gaps) == 1
...
def test_tags_alone_are_not_reported():
    ...
    assert _gaps("alarmdef_l902ts_noinst_t04") == []
