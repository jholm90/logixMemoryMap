; Logix Designer build/verify + Capacity capture loop.
...
;
; Confirmed empirically on the machine:
...
^F1:: {
    ...
    Loop {
        ...
        ; popup at all ("The 1769/L7 processors don't build
        ...
        ; Disabled -- found it wasn't actually firing at
