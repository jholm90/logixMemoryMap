...
## L9 (ControlLogix 5590) — done

Closed by `gen_l9_v38.py` (96 files, captured clean): on 32 content items from an empty
controller to 1,600 density units, 21 instructions and 6 module/alarm types, an L81E at
v38 reads the same as at v35 and an L9 at v38 reads the L81E figure plus a flat 2,276,
which the engine charges (OQ-L9PLATFORM). Capacity is the published user memory, 2 / 5 /
8 / 15 MB (OQ-L9BUDGET). No further L9 tests are planned.
